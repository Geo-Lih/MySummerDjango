...
from .views import OrderDetail, OrderItemCreate, OrdersHistoryList, PaymentAndShipmentCreate, PaymentUpdate, \
...
urlpatterns = [
    ...
    path('order_detail/<int:pk>/', OrderDetail.as_view(), name='order_active'),

"""
Django settings for DaiDomivky project.
...
SECRET_KEY = 'django-insecure-_jplqo*hcsfx*pqh#1r7u(5@=r_q@v-=jts3h$ax#p10-(1y66'
...
WSGI_APPLICATION = 'DaiDomivky.wsgi.application'
